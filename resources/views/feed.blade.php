...
@section('content')
    ...
    <div class="mt-4 w-full flex flex-col justify-start items-center gap-4 font-bold">
        @foreach ($dailyFixtures as $fixtureGroup)
            <div class="w-full flex flex-col border-3 border-amber-300 ring-3 ring-amber-900 rounded-xl overflow-hidden">
                @foreach ($fixtureGroup as $fixture)
                    ...
                    @endphp
                    <a href="{{ $url }}" class="active:bg-blue-900 p-4 flex justify-between items-center border-b border-amber-300 last:border-b-0">
