...
@section('content')
    ...
    <div class="flex flex-col">
        @foreach ($fixtures as $fixture)
            ...
            @endphp
            <a href="{{ $url }}" class="py-5 flex justify-between items-center border-b border-gray-800 first:border-t">
                ...
                @if ($fixture->userBet)
                    @if ($fixture->is_finished)
                        ...
                        @else
                            <svg xmlns="http://www.w3.org/2000/svg" class="text-red-900" width="16" height="16" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
                                <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M5.354 4.646a.5.5 0 1 0-.708.708L7.293 8l-2.647 2.646a.5.5 0 0 0 .708.708L8 8.707l2.646 2.647a.5.5 0 0 0 .708-.708L8.707 8l2.647-2.646a.5.5 0 0 0-.708-.708L8 7.293z"/>
                            </svg>
                        @endif
                    @else
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-gray-200" width="16" height="16" fill="currentColor" class="bi bi-circle-fill" viewBox="0 0 16 16">
                            <circle cx="8" cy="8" r="8"/>
                        </svg>
                    @endif
                @else
                    <svg xmlns="http://www.w3.org/2000/svg" class="text-gray-800" width="16" height="16" fill="currentColor" class="bi bi-circle" viewBox="0 0 16 16">
