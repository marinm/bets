...
@section('content')
    <div class="bg-cyan-100 w-full border-b-4 border-b-yellow-800 p-4 flex justify-between items-center text-amber-900">
    ...
    <div class="border-t-4 border-t-amber-400 bg-orange-50 w-full flex flex-col justify-start items-center font-bold">
        @foreach ($dailyFixtures as $fixtureGroup)
            <div class="w-full flex flex-col overflow-hidden">
                @foreach ($fixtureGroup as $fixture)
                    ...
                    @endphp
                    <a href="{{ $url }}" class="p-4 flex justify-between items-center border-b-2 border-amber-300">
