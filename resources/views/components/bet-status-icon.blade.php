<div>
    @if ($bet)
        @if ($bet->status == App\Enums\BetStatus::Pending)
        ...
        @elseif ($bet->status == App\Enums\BetStatus::Won)
            <svg xmlns="http://www.w3.org/2000/svg" class="text-lime-400" width="16" height="16" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
        ...
        @elseif ($bet->status == App\Enums\BetStatus::Void)
