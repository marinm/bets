...
@section('content')
    ...
    <div class="bg-gray-800 p-4 mt-10 mb-4 rounded border border-white">
        <div class="flex items-center justify-start gap-1">
            <p class="text-amber-900 text-lg font-bold truncate">{{ $fixture->team1->long_name }}</p>
        </div>
        <div class="flex items-center justify-start gap-1">
            <p class="text-amber-900 text-lg font-bold truncate">{{ $fixture->team2->long_name }}</p>
        </div>
    ...
    <form action="{{ route('fixture-bets.store', ['fixture' => $fixture]) }}" method="POST">
        ...
        <div class="border border-white rounded">
            <label class="flex justify-between items-center text-amber-900 p-4 border-b border-white">
                <div>
                ...
                <div class="font-mono text-amber-900-800">
            ...
            @if ($fixture->can_draw)
                <label class="flex items-center text-amber-900 p-4">
        ...
        <div class="flex justify-center items-center">
            <button type="submit" class="mx-auto mt-12 px-12 py-4 bg-blue-500 text-amber-900 rounded-full">Bet</button>
        </div>
    </form>
@endsection
