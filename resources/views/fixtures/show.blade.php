...
@section('content')
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-amber-900 text-2xl font-bold">Fixture</h1>
        <a href="{{ route('fixtures.edit', ['fixture' => $fixture]) }}" class="px-4 py-2 bg-blue-500 text-amber-900 rounded">Edit</a>
    </div>
